...
export interface IPendingRegistrationEvent extends IBaseGlobalEvent {
...
export type PendingRegistrationEventHandler = (e: IPendingRegistrationEvent) => void;
...
export interface ScreenSetParams {
    ...
    onBeforeValidation: BeforeValidationEventHandler;
    onAfterValidation: AfterValidationEventHandler;
    onCompleteRegistration: PendingRegistrationEventHandler;
    version?: number;
